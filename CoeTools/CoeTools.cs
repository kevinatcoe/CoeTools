...
using static CoeTools.Query.DataType;
using static CoeTools.Log;
using static CoeTools.DtTools;
using static CoeTools.Strings;
using static CoeTools.SystemTools;
...
namespace CoeTools
{
    ...
    public class ConfigFile
    {
        ...
        public int ItemInt(string Key)
        {
            try
            {
                ...
                while (index < pairs.Count && !exitLoop)
                {
                    if (pairs[index].Key.ToLower() == Key.ToLower())
                    {
                        returnValue = int.Parse(pairs[index].Value.Trim());
                        exitLoop = true;
                    }
                    index++;
                }
        ...
        public int Load()
        {
            ...
            {
                log.Exception("AppConfig.Load", ex, true);
                log.Write("Path = " + Path);
                log.Write("Line = " + line);
                return -1;
            }
        ...
        public List<string> GetAll(string keyValue)
        {
    ...
    public class Log
    {
        ...
        public void Exception(string source, Exception e, Boolean showDetails = false)
        {
            Write("####################");
        ...
        public void ClearText()
        {
            try
            {
                ...
                Write($"**** LOG CLEARED **** {DateTime.Now.ToShort()}");
            }
            catch (Exception e)
            {
                Exception("Tools.Log.ClearText", e, true);
            }
        }
        ...
        public void ClearSql()
        {
            ...
            {
                Exception("Tools.Log.ClearSql", e, true);
            }
        }
        public void Clear()
        {
        ...
        public static void logerror(string Source, Exception ex, bool ShowDetails = true)
        {
            System.IO.Directory.CreateDirectory(@"C:\Temp\");
            Log log = new Log(@"C:\Temp\" + Assembly.GetExecutingAssembly().GetName().Name + ".log");
            log.Exception(Source, ex, ShowDetails);
        }
        #endregion Methods
    }
    ...
    public class Query : IDisposable
    {
        ...
        public void AddParameter(String Name, SqlDbType Type, String Value)
        {
            ...
            {
                log.Exception("Query.AddParameter", ex, true);
            }
        }
        ...
        public Boolean Exists(string TableName, string FieldName, string FieldValue)
        {
            ...
            {
                log.Exception("Query.Exists()", ex, true);
                return false;
            }
        }
        ...
        public void Execute()
        {
            ...
            {
                log.Exception("Execute :: " + strSource, ex, true);
                log.Write(strQuery);
            }
        }
        ...
        public void UpdateTable(DataTable dt, String TableName)
        {
            ...
            {
                log.Exception("Query.UpdateTable", ex, true);
            }
        }
        ...
        public void InsertTable(DataTable dt, String TableName)
        {
            ...
            {
                l.Exception("Query.InsertTable", ex, true);
            }
        }
        #endregion Methods
    } // public class Query
    public class ServerConnection
    {
        ...
        public string IntegratedConnectionString()
        {
            string FormattedInstance = "";
            if (strInstance != "")
            {
            ...
            string connectionString = $"server={strServer + FormattedInstance};database={strDatabase};Integrated Security=SSPI;persist security info=False";
        ...
        public bool ValidConnection()
        {
            ...
            {
                log.Exception(" ValidConnection()", ex, true);
                return false;
            }
        }
    }
    ...
    public class SqlTable
    {
        ...
        public void GetAll()
        {
            if (PhysicalName.Trim() != "")
            {
                try
                {
                    ...
                    Query q = new Query($"SqlTable.GetAll() {DisplayName}", qs, dtDataTable, Connection, false);
                    q.Execute();
        ...
        public List<string> GetAll(string columnName, bool ShowQuery, string orderByColumn = "")
        {
            try
            {
                ...
                Query q = new Query("SqlTable.GetWhere(criteria)", qs, dtStringList, Connection, false);
                q.Execute();
                if (ShowQuery)
                {
        ...
        public int GetNext(string valueField, string KeyField, string KeyValue)
        {
            ...
            Query q = new Query("SqlTable.GetMax()", qs, dtString, Connection, true);
            q.Execute();
        ...
        public void GetWhere(string KeyField, string KeyValue)
        {
            string qs = $"SELECT * FROM {PhysicalName}";
            qs = qs + $" WHERE {KeyField.Trim()} = '{KeyValue.Trim()}'";
            Query q = new Query("SqlTable.GetWhere()", qs, dtDataTable, Connection, false);
            q.Execute();
            Table = q.dataTableResult;
            q.Dispose();
        }
        ...
        public DataTable GetWhere(string criteria, bool ShowQuery)
        {
            try
            {
                ...
                Query q = new Query("SqlTable.GetWhere(criteria)", qs, dtDataTable, Connection, false);
                q.Execute();
                if (ShowQuery)
                {
                    logit($"SqlTable.GetWhere(criteria) => {qs}");
        ...
        public int GetCount(string criteria, bool ShowQuery)
        {
            try
            {
                ...
                qs = qs + $" WHERE {criteria}";
                Query q = new Query("SqlTable.GetCount(criteria)", qs, dtInteger, Connection, false);
                q.Execute();
                if (ShowQuery)
                {
        ...
        public int GetInt(string columnName, string criteria, bool ShowQuery = false)
        {
            try
            {
                string qs = $"SELECT {columnName} FROM {PhysicalName}";
                qs = qs + $" WHERE {criteria}";
                Query q = new Query("SqlTable.GetInt(criteria)", qs, dtInteger, Connection, false);
                q.Execute();
                if (ShowQuery)
                {
                    logit($"SqlTable.GetCount(criteria) => {qs}");
        ...
        public void Update(string keyField, string keyValue, string updateField, string updateValue)
        {
            ...
            else
            {
                ...
                qs = qs + $" WHERE {keyField.Trim()} = '{keyValue.Trim()}'";
                Query q = new Query("SqlTable.Update()", qs, dtDataTable, Connection, false);
                q.Execute();
                q.Dispose();
            }
        }
        public void Update(string criteria, string updateField, string updateValue)
        {
            ...
            else
            {
                ...
                qs = qs + $" SET {updateField.Trim()} = '{updateValue.Trim()}'";
                qs = qs + $" WHERE {criteria} ";
                Query q = new Query("SqlTable.Update(criteria,updateField,updateValue)", qs, dtDataTable, Connection, false);
                q.Execute();
                q.Dispose();
            }
        }
        public void UpdateColumn(string tableName, string criteria, string updateField, string updateValue)
        {
            ...
            else
            {
                ...
                Query q = new Query("SqlTable.Update(tableName,criteria,updateField,updateValue)", qs, dtVoid, Connection, false);
                q.Execute();
            }
        }
        public void UpdateColumns(string tableName, string criteria, string[] updatecolumns, string[] updateValue, string[] updateTypes)
        {
            ...
            else
            {
                ...
                Query q = new Query("SqlTable.Update(tableName,criteria,updateField,updateValue)", qs.ToString(), dtVoid, Connection, false);
                q.Execute();
            }
        }
        public void Insert(string[] fieldArray, string[] valueArray)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Query q = new Query("SqlTable.Insert()", qs, dtVoid, Connection, false);
                    q.Execute();
                }
            }
            catch (Exception ex)
        ...
        public void Delete(string criteria, bool ShowQuery = false)
        {
            try
            {
                ...
                qs = qs + $" WHERE {criteria}";
                Query q = new Query("SqlTable.Delete(criteria,ShowQuery)", qs, dtVoid, Connection, false);
                q.Execute();
                if (ShowQuery)
                {
    ...
    public class Strings
    {
        ...
        public static String DecimalFormat(String origString, int DecimalPlaces)
        {
            ...
            if (double.TryParse(origString, out n) == true)
            {
                ...
                {
                    log.Exception("DecimalFormat", ex, true);
                    return origString;
                }
            }
            return null;
        ...
        public static String MakeString(object obj)
        {
            ...
            {
                log.Exception("MakeString", ex, true);
                return null;
            }
        }
    ...
    {
        public static bool NullOrEmpty(this string origString)
        {
        ...
        public static string Choose(this string origString, string subString)
        {
            if (origString.NullOrEmpty())
            {
                return subString;
            }
            else
    ...
    public static class TextFile
    {
        ...
        public static void CreateTextFile(string filePath, string data)
        {
            try
            {
                using (FileStream fs = File.Create(filePath))
                {
                    byte[] dataToWrite = new UTF8Encoding(true).GetBytes(data);
